...
<?php
       ...
       $in  = str_repeat('?,', count($CID) - 1) . '?';
        ...
        $sql = "SELECT  CONSUMER.CNAME,CONSUMER.SRNO,CONSUMER.SERVICENO,CONSUMER.OLDACCNO,CONSUMER.ACCNO,CONSUMER.AREACODE,CONSUMER.METERSIZE,
			...
			<table class="table"  border="1"   cellspacing="0" cellpadding="0">
				<tbody>
					...
					<tr class="table2">
						...
						<td class="content">--</td>
						<td class="content" style="text-align: left;"><?php echo floor($CURREADING);?></td>
						<td class="content" style="text-align: left;"><?php echo floor($PREVREADING);?></td>
			...
			<table class="table"   border="1"  cellspacing="0" cellpadding="0" > 
				<tbody>
					...
					<tr class="table3">
						...
						<td class="content"><?php echo '--';?></td>
						<td class="content"><?php echo '--';?></td>
						<td class="content"><?php echo floor($USEDLTR);?></td>
