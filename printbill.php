...
<?php
       ...
       $in  = str_repeat('?,', count($CID) - 1) . '?';
        ...
        CONSUMER.CUID,CONSUMER.CNAMEH,CONSUMER.FNAMEH,CONSUMER.ADDRESSH,CONSUMER.GOVTREB,    BILLDETAIL.CURREADING,BILLDETAIL.PREVREADING ,BILLDETAIL.LASTBPYDATE, BILLDETAIL.USEDLTR,BILLDETAIL.NOOFMONTH ,BILLDETAIL.WCHARGE, BILLDETAIL.SCHARGE,  BILLDETAIL.ADVANCE,
         BILLDETAIL.METERRENT, BILLDETAIL.WSCHARGE , BILLDETAIL.OUTSTANDING, BILLDETAIL.AFTERDISCOUNT , BILLDETAIL.DCHARGE ,BILLDETAIL.SSCHARGE, BILLDETAIL.TOTALBILL ,BILLDETAIL.BILLMONTH ,BILLDETAIL.INTOTH FROM CONSUMER  INNER JOIN BILLDETAIL  ON BILLDETAIL.CID = CONSUMER.CID  WHERE  CONSUMER.CID IN ( ".implode(',',$CID).") AND BILLDETAIL.BILLMONTH=:billmonth ORDER BY CONSUMER.ACCNO ASC";
			...
			<table class="table"   border="1"  cellspacing="0" cellpadding="0" > 
				<tbody>
					...
					<tr class="table3">
						...
						<td class="content"><?php echo $GOVTREB;?></td>
						<td class="content"></td>
						<td class="content"></td>
			...
			<table class="table"  border="1"  cellspacing="0" cellpadding="0">
				<tbody>
					...
					<tr class="table4">
						<td class="content"><?php echo $WCHARGE;  ?></td>
						<td class="content"><?php echo $SCHARGE;?></td>
						<td class="content"><?php echo $SSCHARGE;?></td>
						...
						<td class="content" style="text-align:left;">--</td>
						<td class="content" style="text-align:left;"><?php echo $INTOTH;?></td>
